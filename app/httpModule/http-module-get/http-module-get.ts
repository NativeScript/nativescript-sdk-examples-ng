...
export class HTTPModuleGetExampleComponent implements OnInit {
    ...
    ngOnInit(){
        ...
        // << getstring-http-module
        // >> getJSON-http-module
        getJSON("https://httpbin.org/get").then((r) => {
        ...
        getImage("https://httpbin.org/image/jpeg").then((r) => {
            this.imagesource = r;
        }, (e) => {
            alert("GetImage: "+e);
        });
        ...
        getFile("https://httpbin.org/image/jpeg", filePath).then((r:File) => {
        ...
        var filePath = path.join(knownFolders.documents().path, "test.png");
        getFile("https://httpbin.org/image/png", filePath).then((r:File) => {
