...
@Component({
    ...
    styleUrls:["ui/listpicker/creating-listpicker/creating-listpicker.component.css"],
    templateUrl: "ui/listpicker/creating-listpicker/creating-listpicker.component.html"
})
