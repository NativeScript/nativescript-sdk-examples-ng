...
@Component({
    ...
    styleUrls:["ui/listview/customizing-listview/customizing-listview.component.css"],
    templateUrl: "ui/listview/customizing-listview/customizing-listview.component.html",
